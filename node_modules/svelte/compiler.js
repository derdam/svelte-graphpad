(function (global, factory) {
	...
	class ElementWrapper extends Wrapper {
	    ...
	    add_directives_in_order(block) {
	        ...
	        const ordered = [].concat(bindingGroups, this.event_handlers, this_binding).filter(Boolean);
	        ordered.sort((a, b) => getOrder(a) - getOrder(b));
	        ordered.forEach(bindingGroupOrEventHandler => {
	            if (bindingGroupOrEventHandler instanceof EventHandlerWrapper) {
	...
	class Component {
	    ...
	    generate(result) {
	        ...
	        if (result) {
	            ...
	            const banner = `${this.file ? `${this.file} ` : ``}generated by Svelte v${'3.16.6'}`;
